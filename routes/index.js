...
router.post('/', (req, res) => {
    ...
    ladder.map((person, index) => {
        ...
        promises.push(briq.organization(process.env.ORGANIZATION).createTransaction(transaction));
    });
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px;" class="email-container">
                                        ...
                                        <tr>
                                            ...
                                            <td bgcolor="#1a2035" valign="middle" style="text-align: center; background-position: center center !important; background-size: cover !important;">
                                                <!--[if gte mso 9]>
                                                <v:image xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="border: 0; display: inline-block; width: 680px; height: 180px;" src="" />
